...
// History (which reads the same records, read-only, filtered to Payment Done). Keyed by
// university id — same idiom as `initialUniversityData` — so switching the university
// selector shows a different set of payout records. Record ids are unique across the
// whole object (not just within one university's array), so an open status/comment popup
// can never resolve to the wrong record if the university is switched mid-popup.
//
// `status` is only ever literally "Pending Payout" or "Payment Done" here — "Bank Details
// Pending" is derived from `bankDetails` being null (see src/utils/payoutStatus.js).
    ...
    jamia_hamdard: [
      {
        ...
        bankDetails: { accountHolderName: "Rahul Sharma", accountNumber: "50100234567890", ifsc: "HDFC0001234", bankName: "HDFC Bank" },
        paymentInfo: null,
      ...
      },
      {
        ...
        amountValue: 5000,
        status: "Payment Done",
        bankDetails: { accountHolderName: "Priya Mehta", accountNumber: "60200345678901", ifsc: "ICIC0002345", bankName: "ICICI Bank" },
      ...
      },
      {
        ...
        amountValue: 4500,
        status: "Pending Payout",
        bankDetails: { accountHolderName: "Amit Singh", accountNumber: "70300456789012", ifsc: "SBIN0003456", bankName: "State Bank of India" },
        paymentInfo: null,
        nudge: { message: DEFAULT_NUDGE_MESSAGE, lastSentAt: null },
        comment: "",
      },
      ...
      },
      {
        ...
        amountValue: 3500,
        status: "Pending Payout",
        bankDetails: { accountHolderName: "Divya Menon", accountNumber: "80400567890123", ifsc: "AXIS0004567", bankName: "Axis Bank" },
        paymentInfo: null,
        nudge: { message: DEFAULT_NUDGE_MESSAGE, lastSentAt: null },
        comment: "",
      },
      {
        ...
        amountValue: 5500,
        status: "Payment Done",
        bankDetails: { accountHolderName: "Karthik Reddy", accountNumber: "90500678901234", ifsc: "PUNB0005678", bankName: "Punjab National Bank" },
    ...
    iit_bhilai: [
      {
        id: 8,
        student: "Ayaan Khan",
        studentId: "IB2026STU031",
        referrer: "Srishti Sen",
        referrerId: "IB2023REF012",
        course: "B.Tech CSE",
        referrerCourse: "B.Tech CSE",
        enrolledDate: payoutDaysAgo(18),
        enrolledDateObj: new Date(new Date().setDate(new Date().getDate() - 18)),
        daysAgo: 18,
        amount: "₹9,000",
        amountValue: 9000,
        status: "Pending Payout",
        bankDetails: { accountHolderName: "Srishti Sen", accountNumber: "11100112233445", ifsc: "HDFC0006789", bankName: "HDFC Bank" },
        paymentInfo: null,
        nudge: { message: DEFAULT_NUDGE_MESSAGE, lastSentAt: null },
        comment: "",
      },
      {
        id: 9,
        student: "Naina Kapoor",
        studentId: "IB2026STU044",
        referrer: "Kabir Singh",
        referrerId: "IB2023REF019",
        course: "B.Tech Data Science",
        referrerCourse: "B.Tech Data Science",
        enrolledDate: payoutDaysAgo(25),
        enrolledDateObj: new Date(new Date().setDate(new Date().getDate() - 25)),
        daysAgo: 25,
        amount: "₹10,000",
        amountValue: 10000,
        status: "Payment Done",
        bankDetails: { accountHolderName: "Kabir Singh", accountNumber: "22200223344556", ifsc: "ICIC0007890", bankName: "ICICI Bank" },
        paymentInfo: { transactionId: "TXN-2026-00511", utrNumber: "UTR2026051100244", pocName: PAYOUT_POC_NAME, pocPhone: PAYOUT_POC_PHONE, date: payoutDaysAgo(10) },
        nudge: { message: DEFAULT_NUDGE_MESSAGE, lastSentAt: null },
        comment: "",
      },
      {
        id: 10,
        student: "Devika Rao",
        studentId: "IB2026STU052",
        referrer: "Rahul Sharma",
        referrerId: "IB2023REF026",
        course: "M.Tech AI & ML",
        referrerCourse: "M.Tech AI & ML",
        enrolledDate: payoutDaysAgo(31),
        enrolledDateObj: new Date(new Date().setDate(new Date().getDate() - 31)),
        daysAgo: 31,
        amount: "₹7,000",
        amountValue: 7000,
        status: "Pending Payout",
        ...
        paymentInfo: null,
        nudge: { message: DEFAULT_NUDGE_MESSAGE, lastSentAt: null },
        comment: "Referrer notified — bank details not yet submitted.",
      },
      {
        id: 11,
        student: "Farhan Ali",
        studentId: "IB2026STU067",
        referrer: "Srishti Sen",
        referrerId: "IB2023REF012",
        course: "B.Tech Electrical",
        referrerCourse: "B.Tech CSE",
        enrolledDate: payoutDaysAgo(9),
        enrolledDateObj: new Date(new Date().setDate(new Date().getDate() - 9)),
        daysAgo: 9,
        amount: "₹8,000",
        amountValue: 8000,
        status: "Pending Payout",
      ...
      },
      {
        id: 12,
        student: "Ritu Dubey",
        studentId: "IB2026STU078",
        referrer: "Kabir Singh",
        referrerId: "IB2023REF019",
        course: "M.Tech Power Systems",
        referrerCourse: "B.Tech Data Science",
        enrolledDate: payoutDaysAgo(44),
        enrolledDateObj: new Date(new Date().setDate(new Date().getDate() - 44)),
        daysAgo: 44,
        amount: "₹6,500",
        amountValue: 6500,
        status: "Payment Done",
        bankDetails: { accountHolderName: "Kabir Singh", accountNumber: "22200223344556", ifsc: "ICIC0007890", bankName: "ICICI Bank" },
        paymentInfo: { transactionId: "TXN-2026-00398", utrNumber: "", pocName: PAYOUT_POC_NAME, pocPhone: PAYOUT_POC_PHONE, date: payoutDaysAgo(19) },
        nudge: { message: DEFAULT_NUDGE_MESSAGE, lastSentAt: null },
        comment: "",
      },
    ],
    ...
    iit_mandi: [
      {
        ...
        studentId: "IM2026STU022",
        referrer: "Meera Nair",
        referrerId: "IM2023REF008",
        course: "B.Tech CSE",
        referrerCourse: "B.Tech CSE",
        enrolledDate: payoutDaysAgo(14),
        enrolledDateObj: new Date(new Date().setDate(new Date().getDate() - 14)),
        daysAgo: 14,
        amount: "₹10,000",
        amountValue: 10000,
        status: "Pending Payout",
        bankDetails: { accountHolderName: "Meera Nair", accountNumber: "33300334455667", ifsc: "KKBK0008901", bankName: "Kotak Mahindra Bank" },
        paymentInfo: null,
        nudge: { message: DEFAULT_NUDGE_MESSAGE, lastSentAt: null },
        comment: "",
      },
      {
        id: 14,
        student: "Pallavi Joshi",
        studentId: "IM2026STU035",
        referrer: "Akash Roy",
        referrerId: "IM2023REF015",
        course: "B.Tech Mechanical",
        referrerCourse: "B.Tech Mechanical",
        enrolledDate: payoutDaysAgo(27),
        enrolledDateObj: new Date(new Date().setDate(new Date().getDate() - 27)),
        daysAgo: 27,
        amount: "₹8,000",
        amountValue: 8000,
        status: "Payment Done",
        bankDetails: { accountHolderName: "Akash Roy", accountNumber: "44400445566778", ifsc: "BARB0009012", bankName: "Bank of Baroda" },
        paymentInfo: { transactionId: "TXN-2026-00463", utrNumber: "UTR2026046300178", pocName: PAYOUT_POC_NAME, pocPhone: PAYOUT_POC_PHONE, date: payoutDaysAgo(13) },
        nudge: { message: DEFAULT_NUDGE_MESSAGE, lastSentAt: null },
        comment: "",
      },
      {
        ...
        studentId: "IM2026STU048",
        referrer: "Tanvi Shah",
        referrerId: "IM2023REF021",
        course: "M.Tech Biotechnology",
        referrerCourse: "M.Tech Biotechnology",
        enrolledDate: payoutDaysAgo(37),
        enrolledDateObj: new Date(new Date().setDate(new Date().getDate() - 37)),
        daysAgo: 37,
        amount: "₹7,000",
        amountValue: 7000,
        status: "Pending Payout",
      ...
      {
        id: 16,
        student: "Ananya Bhatt",
        studentId: "IM2026STU056",
        referrer: "Meera Nair",
        referrerId: "IM2023REF008",
        course: "PhD Physics",
        referrerCourse: "B.Tech CSE",
        enrolledDate: payoutDaysAgo(48),
        enrolledDateObj: new Date(new Date().setDate(new Date().getDate() - 48)),
        daysAgo: 48,
        amount: "₹5,000",
        amountValue: 5000,
        status: "Payment Done",
        bankDetails: { accountHolderName: "Meera Nair", accountNumber: "33300334455667", ifsc: "KKBK0008901", bankName: "Kotak Mahindra Bank" },
        paymentInfo: { transactionId: "TXN-2026-00371", utrNumber: "", pocName: PAYOUT_POC_NAME, pocPhone: PAYOUT_POC_PHONE, date: payoutDaysAgo(22) },
        nudge: { message: DEFAULT_NUDGE_MESSAGE, lastSentAt: null },
        comment: "",
      },
    ],
...
export const initialUniversityData = {
  jamia_hamdard: {
    ...
    programs: withPolicyDefaults([
      ...
      { name: "MBA Finance", converted: 15, leads: 22, cost: 200000, referralPercent: 5.00, referrerIncentive: 5000, refereeDiscount: 10, effectiveFrom: "01 Jun 2026", effectiveTo: "31 May 2027", type: "PG", flagged: 2, inProcess: 5, referrerData: { converted: 4, flagged: 0, inProcess: 2 }, refereeData: { converted: 15, flagged: 2, inProcess: 5 } },
